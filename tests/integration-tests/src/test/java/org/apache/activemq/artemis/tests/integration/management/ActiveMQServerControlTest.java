...
public class ActiveMQServerControlTest extends ManagementTestBase {
   ...
   public void testListQueues() throws Exception {
      ...
      Assert.assertEquals("temporary", "false", array.getJsonObject(0).getString("temporary"));
      Assert.assertEquals("purgeOnNoConsumers", "false", array.getJsonObject(0).getString("purgeOnNoConsumers"));
      Assert.assertEquals("consumerCount", "0", array.getJsonObject(0).getString("consumerCount"));
      ...
      Assert.assertEquals("routingType", RoutingType.ANYCAST.name(), array.getJsonObject(0).getString("routingType"));
